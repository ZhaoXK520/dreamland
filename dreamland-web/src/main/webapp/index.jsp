        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <c:if test="${order=='time'}">
                    <li class="active"><a href="${ctx}/index_list">最新文章</a></li>
                </c:if>
                <c:if test="${order!='time'}">
                    <li><a href="${ctx}/index_list">最新文章</a></li>
                </c:if>

                <c:if test="${order=='hot'}">
                    <li class="active"><a href="${ctx}/index_list_hot">最热文章</a></li>
                </c:if>
                <c:if test="${order!='hot'}">
                    <li ><a href="${ctx}/index_list_hot">最热文章</a></li>
                </c:if>

                <li class="dropdown">
                    <a>文章分类</a>
                    <div class="dropdown-menu" role="menu">
                        <a onclick="changeCategory('技术')">技术</a>
                        <a onclick="changeCategory('随笔')">随笔</a>
                        <a onclick="changeCategory('文学')">文学</a>
                        <a onclick="changeCategory('日志')">日志</a>
                        <a onclick="changeCategory('娱乐')">娱乐</a>
                        <a onclick="changeCategory('其他')">其他</a>
                    </div>
                </li>
                ...
                <c:if test="${order!='me'}">
                    <li><a href="${ctx}/index_list_me">我的文章</a></li>
                </c:if>
        ...
        <div class="col-md-9"  style="background-color: white;">
                ...
                <c:forEach var="cont" items="${page.result}" varStatus="i">
                    ...
                    <div class="content-text" >
                        ...
                        <div class="author clearfix">
                            <div>
                                <a href="/space?id=${cont.uId}" target="_self" rel="nofollow" style="height: 35px;margin-top: 10px">
                                     <img src="${cont.imgUrl}">
                                </a>
                            </div>
                                ...
                                <div class="author-h2">
                                    <div style="float: left;font-size: 15px;color: #9b8878">
                                        <a href="/space?id=${cont.uId}">${cont.nickName}</a>
                                    </div>
                                    <div style="float: left;margin-left: 10px;color: grey;margin-top: 10px;font-size: 12px">
                                         ${cont.formatDate}
                                    </div>
                                </div>
                        ...
                        <a href="${ctx}/only_watch?cid=${cont.id}">
                        <h2>${cont.title}</h2>
                        </a>
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1 && order=='time'}">
                        <li class="previous"><a href="${ctx}/index_list?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    <c:if test="${page.pageNum > 1 && order=='hot'}">
                        <li class="previous"><a href="${ctx}/index_list_hot?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    <c:if test="${page.pageNum > 1 && order=='me'}">
                        <li class="previous"><a href="${ctx}/index_list_me?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    ...
                    <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pn">
                        ...
                        <c:if test="${page.pageNum!=pn&& order=='time'}">
                            <li ><a href="${ctx}/index_list?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                        <c:if test="${page.pageNum!=pn&& order=='hot'}">
                            <li ><a href="${ctx}/index_list_hot?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                        <c:if test="${page.pageNum!=pn&& order=='me'}">
                            <li ><a href="${ctx}/index_list_me?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum<page.pages&& order=='time'}">
                        <li><a href="${ctx}/index_list?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
                    <c:if test="${page.pageNum<page.pages&& order=='hot'}">
                        <li><a href="${ctx}/index_list_hot?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
                    <c:if test="${page.pageNum<page.pages&& order=='me'}">
                        <li><a href="${ctx}/index_list_me?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
                ...
                <div class="foot-nav clearfix">
                    ...
                    <div class="foot-nav-col">
                        ...
                        <ul>
                            <li>
                                <a href="#"
                                   target="_self" rel="external nofollow">
                                    Android 客户端
                                </a>
                            </li>
                            <li>
                                <a href="#" target="_self" rel="external nofollow">
                                    iPhone 客户端
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="foot-nav-col">
                        ...
                        <ul>
                            <li>
                                <a href="http://www.dreamsland.club" onMouseOut="hideImg()"  onmouseover="showImg()">
                                    微信
                            ...
                            <li>
                                <a href="http://www.dreamsland.club" target="_self" rel="external nofollow">
                                    QQ空间
                                </a>
                            </li>
                        </ul>
               ...
               <!-- rgba(60,63,65,0.31)-->
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p>
                            <span>邮箱：zxkcomeon@163.com</span>
                        </p>
                        <p style="margin-top: 8px">&copy;www.dreamsland.club 理想乡版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
...
<script language=javascript>
    ...
    function changeCategory(category){
        window.location.href="${ctx}/index_category?category="+encodeURI(encodeURI(category));
    }
    ...
    function act(id) {
        let classAtr = document.getElementsByClassName("menu").getAttribute("class");
        let newClass = classAtr.replace("active","");
        document.getElementsByClassName("menu").setAttribute(newClass);
        document.getElementById(id).setAttribute(classAtr);
    }
