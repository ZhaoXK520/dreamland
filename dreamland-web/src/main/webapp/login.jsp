        ...
        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-sm-offset-4 login-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="account-login">
                    <form id="normal_form" name="form" role="form" class="login-form" action="${ctx}/doLogin?oldPath=${oldPath}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="code"  name="code" class="form-control" autocomplete="off" placeholder="验证码" onblur="checkCode()" >
                        </div>
