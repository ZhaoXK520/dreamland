...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">Dreamland - 理想乡激活成功页面</span>
    </div>
    <div class="content">
        ...
        <div style="margin-left: 340px"> <span style="font-size: 17px;">您登陆理想乡的用户名为：<span style="color: green;font-weight: bold">${email}</span></span></div>
