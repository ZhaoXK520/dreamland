    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="${ctx}/index_list_me" target="_self">我的文章</a></li>
                <li><a href="${ctx}/index_list" target="_self">首页</a></li>
            </ul>
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/profile" target="_self">设置</a></li>
            </ul>

            <ul class="nav navbar-nav">
                <li><a href="${ctx}/writedream" target="_self">写文章</a></li>
                <li><a href="${ctx}/admin" target="_self">后台管理</a></li>
            </ul>
            <ul class="nav navbar-nav" style="margin-left: 680px">
                <li><a href="${ctx}/list?id=${user.id}">${user.nickName}</a></li>
            </ul>
...
<div class="author-card follow-box">
    <div class="designer-card card-media">
        ...
        <div class="avatar-container-80 center">
            <a href="#" title="${user.nickName}" class="avatar" target="_self">
        ...
        <div class="author-info">
            <p class="author-info-title">
                <a title="${user.nickName}" href="#"
                   class="title-content">${user.nickName}
                </a>
            </p>
            ...
            <div>
                ...
                <div style="width: 35px;height: 18px;background-color: #4cae4c;float: left;line-height: 15px;margin-top: 30px;margin-left: 20px">
                    <span style="color: white;font-size: 12px">发表数量</span>
                </div>
                <div style="width: 18px;height: 18px;background-color: #2b542c;float: left;line-height: 15px;margin-top: 30px;">
...
<div class="ibx-advice" onmouseover="changeBackColor();" onmouseout="back2color();">
    <a href="${ctx}/writedream"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#1b1b1b;font-size:30px;" title="写文章"></span></a>
</div>
        ...
        <div class="foot-nav clearfix">
            ...
            <div class="foot-nav-col">
                ...
                <ul style="color: white">
                    <li>
                        <a href=""
                           target="_self" rel="external nofollow" style="color: white">
                            Android 客户端
                        </a>
                    </li>
                    <li>
...
<script>
   ...
   function changeToActive(id,category,pageNum) {
       var ulist_id = "";
       if(typeof (id)=="object"){   //typeof(null) = object
           ulist_id = id.id;
       }else{
           ulist_id = id;
       }
