...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <!-- 品牌名称或logo -->
            <a class="navbar-brand" href="javascript:void(0);" target="_self">个人空间</a>
        </div>
        <!-- 导航项目 -->
        <div class="collapse navbar-collapse navbar-collapse-example">
            <!-- 一般导航项目 -->
            <ul class="nav navbar-nav">
                <li class="active"><a href="/index_list_me" target="_self">我的文章</a></li>
            ...
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/writedream?id=${user.id}" target="_self">写文章</a></li>
            </ul>
            <ul class="nav navbar-nav" style="margin-left: 680px">
                <li><a href="${ctx}/list?id=${user.id}" target="_self">${user.nickName}
    ...
    <div style="text-align: center">
        ...
        <div style="float: left;margin-top: 40px;margin-left: 50px">
            ...
            <form action="${ctx}/updatePassword" method="post" id="update_password">
                <input onblur="oldPassword();" id="old_password" name="old_password" type="password" placeholder="    输入密码" style="width: 350px;height: 50px"/><br/><br/>
                <span id="old_span" style="color:red;"></span><br/><input onblur="rePassword();" id="repassword" type="password" placeholder="    确认新密码" style="width: 350px;height: 50px"/><br/><br/><br/>
                <br/>
