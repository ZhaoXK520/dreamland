...
<div class="container">
    ...
    <div style="position: absolute;margin-left: 980px;margin-top: -40px;">
        <c:if test="${empty user}">
            <a name="tj_login" class="lb" href="login?error=login" target="_self" style="color: black">[登录]</a>
            &nbsp;&nbsp;
            <a name="tj_login" class="lb" href="register" target="_self" style="color: black">[注册]</a>
        </c:if>
        <c:if test="${not empty user}">
            ...
            &nbsp;&nbsp;
            <a name="tj_login" class="lb" href="${ctx}/loginout" target="_self" style="color: black">[退出]</a>
        </c:if>
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${ctx}/index_list" target="_self">首页</a>
        </div>
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/index_list" target="_self">最新文章</a></li>
                <li><a href="${ctx}/index_list_hot" target="_self">最热文章</a></li>
                ...
                <li><a href="${ctx}/index_list_me" target="_self">我的文章</a></li>
                <li><a href="${ctx}/list?id=${user.id}" target="_self">个人空间</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-9"  style="background-color: white;">
            <div id="content_col" class="content-main">
                ...
                <c:forEach var="cont" items="${page.result}" varStatus="i">
                    ...
                    <div class="content-text" >
                        ...
                        <div class="author clearfix">
                            ...
                            <div class="author-h2">
                                <div style="float: left;font-size: 15px;color: #9b8878">
                                    <a href="/space?id=${cont.uId}" target="_self">${cont.nickName}</a>
                                </div>
                        ...
                        <a href="${ctx}/only_watch?cid=${cont.id}" target="_self">
                            <h2>${cont.title}</h2>
                        </a>
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1}">
                        <li class="previous"><a href="${ctx}/index_category?pageNum=${page.pageNum-1}&&category=${category}">« 上一页</a></li>
                    </c:if>
                    ...
                    <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pn">
                        ...
                        <c:if test="${page.pageNum!=pn}">
                            <li ><a href="${ctx}/index_category?pageNum=${pn}&&category=${category}">${pn}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum<page.pages}">
                        <li><a href="${ctx}/index_category?pageNum=${page.pageNum+1}&&category=${category}">下一页 »</a></li>
                    </c:if>
