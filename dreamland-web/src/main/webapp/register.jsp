...
<head>
	<meta charset="UTF-8">
	<title>注册页面</title>
	<meta name="keywords" content="理想乡">
	<meta name="content" content="理想乡">
    	...
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <input id="nickName" name="nickName" type="text" class="kuang_txt possword" placeholder="昵称" onblur="checkNickName();">
                  ...
                  <input id="code" name="code" type="text" class="kuang_txt yanzm" autocomplete="off" placeholder="验证码" onblur="checkCode()">
                  <div>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_self" ><span class="lan">《理想乡用户协议》</span></a></span>
                    <br/>
...
<script type="text/javascript">
    ...
    function checkPhone(){
        ...
        if(!(/^1[2|3|4|5|8|7|8|9][0-9]\d{8}$/.test(phone))){
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受理想乡用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
